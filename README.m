...
## Aim  
To learn about switch case and if else conditions.
...
Prompt User: Display the message `"Enter an integer to check for even or odd"` to request input.  
...
### Program 4: Game Menu using Switch Case  
...
### Program 5: Calculator using Switch Case  
